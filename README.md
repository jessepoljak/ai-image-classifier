...
|--------------------------------------|:-----------------------------------------:|---------------------------------:|
|  News articles with an images        |     User inputs image in question         | Preserving journalism            |
...
|     Marketing and Advertising        |      Aplicable on all platforms           | Consumer Protect (FTC)           |
